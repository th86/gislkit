...
//Exact Concordance Index
double exactci_c(const double* predictions, const double* observations, R_len_t n)
{
...
SEXP exactciR2C(SEXP predIn, SEXP obsIn){
	SEXP out;
	...
	*o = exactci_c(predictions, observations, n);	//call the real function
	UNPROTECT(3);
	return out;
